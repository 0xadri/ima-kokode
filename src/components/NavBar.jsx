  ...
  return (
    <nav class="bg-white shadow dark:bg-gray-800 mb-10">
      <div class="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
        <Link
          to="/"
          className="border-b-2 border-transparent text-gray-800 transition-colors duration-300 transform dark:text-gray-200  hover:border-blue-500 mx-1.5 sm:mr-6"
        >
          home
        </Link>
        ...
        <Link
          to="/Playground"
          class="border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 sm:ml-6 sm:mr-1"
        >
          <svg
